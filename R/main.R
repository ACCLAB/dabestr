...
#'
#' @param dabest.object A \c?ode{\link{dabest}} object, generated by the function of the same name.
#'
#'
...
#'
#' @export
print.dabest <- function(dabest.object, ...) {

  #### Check object class ####
  if (class(dabest.object)[1] != "dabest") {
    stop(paste(
