...
2.  It presents the \*\*effect size\*\_\*\* as a **bootstrap 95% confidence interval** on a **separate but aligned axes**.
...
# Produce a Gardner-Altman estimation plot.
...
Please open a [new issue](https://github.com/ACCLAB/dabestr/issues). Include a reproducible example (aka [reprex](https://www.tidyverse.org/help/)) so anyone can copy-paste your code and move quickly towards helping you out!
